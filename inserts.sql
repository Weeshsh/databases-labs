...
('Sygnet typu 0', 2642.19, 9787.35, 1.20, 14, 1, '370%', 'Magazyn'),
('Sygnet typu 5', 1045.63, 20908.66, 10.37, 46, 1, '1999%', 'Warsztat'),
('Broszka typu 3', 1150.53, 16074.34, 3.77, 2, 0, '1397%', NULL),
('Kolczyki typu 1', 1326.60, 24715.00, 8.40, 97, 0, '1863%', NULL),
('Pierscionek typu 2', 3444.70, 23536.56, 10.79, 85, 1, '683%', 'Warsztat'),
('Naszyjnik typu 5', 3354.01, 7276.85, 10.75, 88, 0, '216%', NULL),
('Bransoletka typu 2', 710.44, 6969.47, 6.23, 18, 1, '981%', 'Magazyn'),
...
('Broszka typu 5', 518.01, 15267.07, 3.68, 41, 1, '2947%', 'Magazyn'),
...
('Bransoletka typu 0', 4246.42, 18448.55, 7.63, 17, 1, '434%', 'Magazyn'),
('Pierscionek typu 1', 462.49, 5089.86, 9.92, 60, 0, '1100%', NULL),
...
('Sygnet typu 0', 12, 5),
('Pierscionek typu 1', 9, 10),
('Sygnet typu 0', 8, 23),
('Kolczyki typu 1', 14, 25),
('Sygnet typu 5', 19, 16),
...
('Sygnet typu 1', 19, 40),
('Broszka typu 5', 11, 43),
('Naszyjnik typu 5', 17, 29),
('Naszyjnik typu 5', 6, 36);