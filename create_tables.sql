...
CREATE TABLE PRACOWNICY(
    ...
    PRZELOZONY INT FOREIGN KEY REFERENCES PRACOWNICY(ID_PRACOWNIKA),
    MIEJSCE_PRACY VARCHAR(20) FOREIGN KEY REFERENCES PLACOWKI(NAZWA),
    STANOWISKO VARCHAR(20) FOREIGN KEY REFERENCES STANOWISKA(NAZWA)
)
...
CREATE TABLE ZAMOWIENIA_NA_ZLOTO(
    ...
    DOSTARCZANA_DO VARCHAR(20) NOT NULL FOREIGN KEY REFERENCES PLACOWKI(NAZWA),
    FIRMA_TRANSPORTOWA VARCHAR(40) NOT NULL FOREIGN KEY REFERENCES FIRMY_TRANSPORTOWE(NAZWA)
)
...
CREATE TABLE PRODUKTY(
    ...
    MIEJSCE_SKLADOWANIA VARCHAR(20) FOREIGN KEY REFERENCES PLACOWKI(NAZWA)
)
...
CREATE TABLE ZAMOWIONE_PRODUKTY(
    ID_PRODUKTU VARCHAR(20) NOT NULL FOREIGN KEY REFERENCES PRODUKTY(NAZWA),
